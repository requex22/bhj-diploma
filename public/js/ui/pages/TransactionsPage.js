 ...
 * */
 class TransactionsPage {
   ...
   * */
  removeAccount() {
    let questionAcc = confirm('Вы действительно хотите удалить счет?');
    if (questionAcc){
  ...
  removeTransaction( id ) {
    let confirmTrans = confirm('Вы действительно хотите удалить транзацию?');
    if (confirmTrans){
   ...
   * */
  renderTitle(name){
    const nonameAcc = this.element.querySelector('.content-title');
    nonameAcc.textContent = name;
  }
